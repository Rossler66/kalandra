...
class clanek_pre extends presenter{
    ...
    function __construct() {
        $this->service = $this->vratObjekt("clanek", "clanek_ser", "clanek_ser");
        $this->template = $this->vratObjekt("clanek", "clanek_tem", "clanek_tem");
    }
    ...
    public function polozka($param){
        ...
        $fotoPar["id"] = $temPar["data"][0]["cla"]->foto;
    ...
    public function uloz($param){
        ...
        $vys = array('typ' => 'stranka', 'data' => "./?clanek/seznam/str=".$param["str"]);
